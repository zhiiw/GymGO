...
export * from 'D:/Class/database/GymGo/django_server/tyadmin/src/models/global';
export * from 'D:/Class/database/GymGo/django_server/tyadmin/src/models/login';
export * from 'D:/Class/database/GymGo/django_server/tyadmin/src/models/setting';
export * from 'D:/Class/database/GymGo/django_server/tyadmin/src/models/user';
